...
do 
  ...
  do
    ...
    out=$gcsOutP #do not include url, bucket, or file extension
    ...
    # $MOSEYENV_SRC/gee_anno.r $geePtsP $gcsOutP
    $MOSEYENV_SRC/gee_anno_hab.r $points $out $studyId ${envs[$i]} ${colnames[$i]} ${bands[$i]}
  done
